...
import View.Tablas.ModelTableAsistencia;
import View.Util.Util_VistaLinked1_Asistencia;
import Controller.tda_listas.ListaEnlazada;
import Controller.tda_listas.exceptions.VacioExceptions;

import static View.Util.UtilVista.getComboAsignatura;

public class Frm_Prueba_Asis extends javax.swing.JFrame {
    ...
    public Frm_Prueba_Asis(Cuenta c) {
        initComponents();
        this.cuenta = c;
        try {
            cargarCombos();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Frm_Prueba_Asis().setVisible(true);
        });
    }
