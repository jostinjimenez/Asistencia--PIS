...
//            if (cc.getFirstKey(claveCifrada, cuenta.getPersona_id()) == false) {
            ...
            if (cuenta != null) {
                switch (cc.getPersona(cuenta.getPersona_id()).getRol_id()) {
                    ...
                    case 3 -> {
                        Frm_Main_Docente fmd = new Frm_Main_Docente(cuenta);
                        fmd.setVisible(true);
                        this.dispose();
                    }
                }
...
//            }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/unl.png"))); // NOI18N
