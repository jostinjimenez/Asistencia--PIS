...
public class Frm_HorarioEstudiante extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        roundPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, 180, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(Frm_HorarioEstudiante.class.getName()).log(Level.SEVERE, null, ex);
        }
        cargarTabla();
