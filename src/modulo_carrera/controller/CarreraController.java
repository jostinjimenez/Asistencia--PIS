...
public class CarreraController extends DataAccessObject<Carrera> {
    ...
    private boolean getForm(Carrera carrera, String text, String campo) {
        return switch (campo.toLowerCase()) {
            case "nombre" -> carrera.getNombre().equalsIgnoreCase(text);
            case "area_estudio" -> carrera.getArea_estudio().equalsIgnoreCase(text);
            case "id" -> Integer.toString(carrera.getId()).equalsIgnoreCase(text);
            case "codigo" -> carrera.getCodigo().equalsIgnoreCase(text);
